# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-08-20 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', '使用中'), ('2', '停用')], default='1', max_length=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=256, verbose_name='代码')),
                ('name', models.CharField(max_length=256, verbose_name='名称')),
                ('value', models.CharField(max_length=256, verbose_name='代码函数')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('begin_date', models.CharField(max_length=10, verbose_name='开始日期')),
                ('end_date', models.CharField(max_length=10, verbose_name='结束日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(choices=[('1', 'linux'), ('2', 'windows')], default='1', max_length=1, verbose_name='系统类型')),
                ('username', models.CharField(blank=True, max_length=32, null=True, verbose_name='登陆帐号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endtime', models.DateTimeField(verbose_name='最后产生告警时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', '在用'), ('2', '停用')], default='1', max_length=2, verbose_name='状态')),
                ('remark', models.CharField(blank=True, max_length=256, null=True, verbose_name='备注')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('1', '任务'), ('2', '步骤'), ('3', '批量任务'), ('4', '循环任务'), ('5', '子任务')], max_length=1, verbose_name='类型')),
                ('up', models.IntegerField(verbose_name='所属任务编号')),
                ('param', models.CharField(blank=True, max_length=5000, null=True, verbose_name='自定义参数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('1', '普通用户'), ('2', '管理员')], default='1', max_length=1, verbose_name='用户类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('1', '系统变量'), ('2', '任务变量'), ('3', '循环任务变量')], max_length=2, verbose_name='类型')),
        ...
        migrations.AlterUniqueTogether(
            name='tasklist',
            unique_together=set([('no', 'type', 'up')]),
        ),
        migrations.AlterUniqueTogether(
            name='sysparam',
        ...
        migrations.AddField(
            model_name='server',
            name='user_profile',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='monitor.UserProfile', verbose_name='设备管理员'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='monitor.UserProfile', verbose_name='用户'),
        ),
    ]
